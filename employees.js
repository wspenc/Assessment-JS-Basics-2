...
//CODE HERE
const empOne = new Employee('Jack', 'weekday mornings and and afternoons');
...
//CODE HERE
let empTwo = {...empOne}
empTwo = new Employee ('Nick', shifts)
console.log(empTwo)
...
//CODE HERE
const manager = new Employee('Winston', 'weekdays, and afternoons', 'Cece and Blake')
